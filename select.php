...
<meta>
    ...
    <tr> 
      <td colspan="4"><font size="2">As same as channel</font> 
      </td>
    </tr>
    <tr>  
...
if($filename !== '..' && $filename !== '.' &&  eregi("ttf", $filename) ){
echo "<option value=\"$filename\" ";  if( $dbfont == $filename){ echo selected; } echo ">$filename</option>\n";
}
}  
  ?>
    </select>
...
if("$sameas" !== ""){ $color = $data[$sameas][14]; }
        ...
        <table width="288" border="0" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
          <tr> 
            <td height="30"><div align="center"><font color="#CC0000" size="2"> 
                Year</font></div></td>
            <td><div align="center"><font color="#CC0000" size="2">Month<br>
                </font><font color="#CC0000" size="2">(1 - 12)</font></div></td>
            <td> <div align="center"><font color="#CC0000" size="2">Day(24)</font></div></td>
            <td> <div align="center"><font color="#CC0000" size="2">Hour</font></div></td>
            <td><div align="center"><font color="#CC0000" size="2">Minute</font></div></td>
            <td><div align="center"><font color="#CC0000" size="2">Second</font></div></td>
          </tr>
          <tr> 
...
if($enddate < time()){ echo "<p>&nbsp;</p><center><font size=2 >The time has already passed</font></center><meta http-equiv=\"refresh\"content=\"3;URL=select.php?mode=timing&change=$change\">"; 
...
global $brr;
if("$brr[2]" == ""){ return date("$let"); }else{ return date("$let", $brr[2]); }
}
title("Recording");
?>
  ...
  <table width="310" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="310"><p><font size="2"><br>
          ...
          <select name="recordwhat" size="1" 
		 onChange=" alla('what',this.options[this.selectedIndex].value)" >		  
...
if( $brr[6] !== $dir && sizeof(@file("txt/rec_$brr[0]_$brr[6].txt")) == 0 ){ unlink("txt/rec_$brr[0]_$brr[6].txt");  }//if txt file exists
if(!is_dir("rec/$dir/")  ){ 
...
function kbtoby(input){ document.form.kb.value=Math.round(input/1024); }
</script>
<table width="488" height="383" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="488" height="84" bgcolor="#F7F4F4"> <form name="form" method="post" action="">
       ...
       <input name="sub_awsettings" type="submit"  value="Set Guides">    </form>
 
</td>
  </tr>
  <tr> 
    <td height="239" bgcolor="#E8EAEC"><form name="form2" method="get" action="http://www.vmist.net/activeworlds/awscripts/awdigie/network_setup.php">
...
<form action="" method="post" name="form" id="form">
  <table width="339" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
      <td width="339"> <div align="center"><font size="2">Select how to layer 
